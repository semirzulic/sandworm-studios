...
const Testimonials: React.FC = () => {
  return (
    <>
      <div id="testimonials" className="py-[50px] md:py-[70px] lg:py-[100px] xl:py-[120px] overflow-hidden">
                ...
                >
                  {testimonialsData &&
                    testimonialsData.map((value, i) => (
                      <SwiperSlide
                        key={i}
                        className="even:bg-[#CAFFF2] odd:bg-[#FFEAEA] rounded-[20px] py-[50px] md:py-[60px] px-[30px] md:px-[50px]"
                      >
