              ...
              <div className="mt-[30px] md:mt-[50px] max-w-[620px] mx-auto">
                <form>
                  <div className="relative sm:pr-[200px]">
                    ...
                    <button
                      type="submit"
                      className="py-[15px] px-[30px] inline-block rounded-[6px] bg-[#CAFFF2] text-[#00373E] font-semibold text-[16px] md:text-[18px] transition duration-500 ease-in-out hover:bg-[#000] hover:text-white sm:absolute top-0 right-0 mt-[20px] sm:mt-[0]"
                    >
                      Get Started Free
                    </button>
                  </div>
