...
const Testimonials: React.FC = () => {
  return (
    <>
      <div
        id="testimonials"
        className="bg-[#232323] py-[50px] md:py-[70px] lg:py-[100px] xl:py-[120px]"
      >
              ...
              >
                {testimonialsData &&
                  testimonialsData.map((value, i) => (
                    <SwiperSlide key={i}>
                      <div className="bg-[#15181B] rounded-[20px] py-[50px] md:py-[60px] px-[30px] md:px-[50px]">
                        <div className="flex items-center space-x-[10px] rtl:space-x-reverse mb-[20px] md:mb-[30px]">
                          <h5 className="text-[#EBEBEB] text-[18px]">{value.ratingTitle}</h5>
                        ...
                        <p className="text-[#EBEBEB]">{value.feedbackText}</p>
                        ...
                        <div className="flex items-center space-x-[15px] rtl:space-x-reverse mt-[20px] md:mt-[30px]">
                          ...
                          <div>
                            <h3 className="text-[#EBEBEB] font-semibold text-[18px] md:text-[20px]">
                              {value.name}
                            </h3>
                            <p className="text-red-color text-[15px]">{value.designation}</p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
