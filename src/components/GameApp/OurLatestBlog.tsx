      ...
      <div id="blog" className="py-[50px] md:py-[80px] lg:py-[100px] xl:py-[120px]">
        <div className="container">
            ...
            <div className="grid gap-[25px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {blogData &&
                blogData.slice(0, 3).map((value, i) => (
                  <div 
                    className="bg-[#232323] rounded-[20px] group"
                    data-aos="fade-up"
                  ...
                  >
                    ...
                    <div className="bg-[#232323] rounded-[20px] py-[40px] px-[30px] relative mt-[-16px] transition duration-500 ease-in-out group-hover:bg-black">
                      <p className="text-[#EBEBEB] uppercase text-[15px] mb-[10px]">
                        {value.category}
                      </p>
                      ...
                      <h3 className="text-[20px] xl:text-[22px] leading-[32px] mb-[15px]">
                        <Link
                          ...
                          className="text-[#EBEBEB] transition duration-500 ease-in-out hover:text-primary-color"
                        >
                          {value.title}
                        </Link>
                      </h3>
                      ...
                      <div className="flex items-center space-x-[15px] md:space-x-[30px] rtl:space-x-reverse">
                        <div className="flex items-center space-x-[8px] rtl:space-x-reverse text-[#EBEBEB]">
          ...
          >
            <Link
              href="/blog"
              className="py-[15px] px-[30px] inline-block rounded-[6px] bg-red-color text-white font-semibold text-[16px] md:text-[18px] transition duration-500 ease-in-out hover:bg-primary-color hover:text-white"
            >
              See All News
            </Link>
          </div>
