...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div
        id="navbar"
        className="navbar-area navbar-style-three z-[2] py-[20px] lg:py-[15px] xl:py-0"
      >
        <div className="container">
          ...
          >
            ...
            <div className="navbar-collapse flex self-center grow basis-auto md:space-x-[20px] lg:space-x-[50px] xl:space-x-[70px] 2xl:space-x-[60px] rtl:space-x-reverse">
              <ul className="navbar-nav self-center flex-row ml-auto rtl:ml-0 rtl:mr-auto md:flex md:space-x-[15px] lg:space-x-[25px] xl:space-x-[35px] 2xl:space-x-[50px] rtl:space-x-reverse">
                <li className="py-[8px] lg:py-[15px] xl:py-[35px] 2xl:py-[38px] relative group">
                  <Link
                    href="#home"
                    className="text-[#EBEBEB] text-[16px] md:text-[16px] lg:text-[18px] font-medium transition-all hover:text-[#FBAD9C]"
                  >
                    Home
                  </Link>
                </li>
              ...
              <div className="other-options self-center space-x-[20px] lg:space-x-[25px] xl:space-x-[45px] rtl:space-x-reverse">
                <Link
                  href="/register"
                  className="py-[10px] md:py-[8px] lg:py-[12px] xl:py-[15px] px-[20px] md:px-[15px] lg:px-[20px] xl:px-[30px] inline-block rounded-[6px] border border-[#EBEBEB] text-[#EBEBEB] font-semibold text-[14px] md:text-[13px] lg:text-[16px] xl:text-[18px] transition duration-500 ease-in-out hover:bg-primary-color hover:text-white hover:border-primary-color"
                >
                  Register Now
                </Link>
              </div>
