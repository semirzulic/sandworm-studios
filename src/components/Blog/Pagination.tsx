      ...
      <nav aria-label="Page navigation example">
        <ul className="text-center space-x-[10px] rtl:space-x-reverse space-y-[10px] md:space-y-[0] mt-[30px] lg:mt-[50px]">
          <li className="inline-block">
            <Link
              href="#"
              className="bg-[#F9F3EF] w-[36px] h-[36px] leading-[32px] rounded-full inline-block text-center "
            >
          ...
          <li className="inline-block">
            <Link
              href="#"
              className="bg-[#F9F3EF] w-[36px] h-[36px] leading-[36px] rounded-full inline-block text-center font-semibold text-[15px] hover:bg-primary-color hover:text-[#fff] transition duration-500 ease-in-out"
            >
              1
            </Link>
          </li>
