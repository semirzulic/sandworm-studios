    ...
    <>
      <div className="py-[50px] md:py-[60px] lg:py-[80px] xl:py-[100px]">
        <div className="container space-y-[10px]">
          ...
          <p>
            Hi there, we’re <strong className="text-black">Plama</strong>, and
            welcome to our Terms and Conditions which also applies to our customers.
            <br />
            This policy sets out how we handle your personal information if
            you’re an <strong className="text-black">Plama</strong> user or
            visitor to our site.
          </p>
          <p>
            When we say ‘we’, ‘us’, or ‘
            <strong className="text-black">Plama</strong>’, it’s because that’s
            who we are and we own and run the site.
            <br />
            If we say ‘policy’ we’re talking about this Terms and Conditions. If we
          ...
          <p>
            ...
            <strong className="text-black">Plama</strong> visitors who do not
            wish to have cookies placed on their browsers should set their
            browsers to refuse cookies before using the{" "}
            <strong className="text-black">Plama</strong> site.
          </p>
          ...
          <p>
            ...
            <strong className="text-black">Plama</strong> services, you can
          ...
          <p>
            ...
            the context of this Terms and Conditions.
          </p>
        </div>
      </div>
    </>
