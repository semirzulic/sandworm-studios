...
const PricingTable: React.FC = () => {
  ...
  return (
    <>
      <div id="pricing" className="bg-[#080D27] py-[50px] md:py-[80px] lg:py-[100px] xl:py-[120px]">
        <div className="container">
          ...
          >
            ...
            <h2 className="text-[28px] text-white md:text-[36px] leading-[36px] md:leading-[45px]">
