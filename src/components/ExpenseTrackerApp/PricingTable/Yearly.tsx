          ...
          <div className="grid gap-[25px] items-center grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <Link
                  href="#"
                  className="py-[15px] px-[20px] block rounded-[6px] bg-primary-color text-white text-center border border-primary-color font-semibold text-[16px] md:text-[18px] transition duration-500 ease-in-out group-hover:bg-[#00373E] group-hover:text-[#CAFFF2]"
                >
                  Get Started
                </Link>
              </div>
            ...
            >
              <div>
                <div className="bg-[#A673EE] text-white uppercase text-center text-[15px] lg:text-[10px] xl:text-[10px] 2xl:text-[15px] py-[4px] md:absolute md:top-0 md:left-0 w-full md:rotate-[-35deg] mb-[15px] md:mb-[0] md:mt-[25px] lg:mt-[8px] xl:mt-[10px] 2xl:mt-[25px] md:ml-[-284px] lg:ml-[-117px] xl:ml-[-145px] 2xl:ml-[-152px]">
                  Popular
                </div>
