            ...
            <div className="grid gap-[25px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {featuresData &&
                featuresData.map((value, i) => (
                  <div
                    className="bg-[#F9F9F9] text-center rounded-[15px] p-[30px] md:p-[40px] group hover:bg-primary-color"
                    data-aos="fade-in"
                    ...
                    key={i}
                  >
                    <div className="bg-[#D4EDFF] text-primary-color w-[75px] h-[75px] mx-auto leading-[75px] rounded-full text-center text-[40px] mb-[25px] group-hover:bg-white">
