...
const AppDownload: React.FC = () => {
  return (
    <>
      <div id="download" className="pb-[50px] md:pb-[70px] lg:pb-[100px] xl:pb-[120px]">
        <div className="container">
          <div className="bg-[#F7F1FF] rounded-[20px] pt-[60px] px-[20px] md:px-[100px] lg:px-[40px] xl:px-[70px] 2xl:px-[100px]">
            <div className="grid gap-[30px] md:gap-[50px] lg:gap-[60px] items-end grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
              <div 
                className="max-w-[560px] mx-auto lg:mx-0 text-center lg:text-left rtl:lg:text-right lg:pb-[50px] xl:pb-[50px] 2xl:pb-[100px]"
                data-aos="fade-in"
                data-aos-delay='100'
