...
const testimonialsData = [
  ...
  },
  {
    ...
    feedbackText:
      "I was amazed by the AI content writing services provided by Alvi. As a busy entrepreneur, I often struggled to find the time to create quality content for my website. However, with their AI-powered solution, I was able to generate engaging and well-written articles in a matter of minutes.",
    image: "/images/users/user1.jpg", // Recommended image size 100x100
    name: "James",
  ...
  },
  {
    ...
    feedbackText:
      "I was amazed by the AI content writing services provided by Alvi. As a busy entrepreneur, I often struggled to find the time to create quality content for my website. However, with their AI-powered solution, I was able to generate engaging and well-written articles in a matter of minutes.",
    image: "/images/users/user2.jpg", // Recommended image size 100x100
    name: "Olivia",
...
const Testimonials: React.FC = () => {
  return (
    <>
      <div id="testimonials" className="bg-[#F9F3EF] py-[50px] md:py-[70px] lg:py-[100px] xl:py-[120px]">
        <div className="container">
          <div className="grid gap-[30px] items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
            <div
              className="max-w-[500px] text-center lg:text-start mx-auto lg:mx-0 xl:max-w-[356px]"
              data-aos="fade-up"
              data-aos-delay="100"
            ...
            >
              ...
              <h2 className="text-[28px] md:text-[36px] leading-[36px] md:leading-[45px] mb-[20px]">
                Some of our happy customer feedback about our products
              </h2>
              <p>
