...
const Features: React.FC = () => {
  return (
    <>
      {featuresData && (
        <div className="overflow-hidden pt-[50px] md:pt-[70px] lg:pt-[50px] xl:pt-[50px]">
          <div className="container">
            <div className="grid gap-[25px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {featuresData &&
                featuresData.map((value, i) => (
                  <div
                    className="bg-[#F5F6F7] rounded-[10px] px-[20px] xl:px-[30px] 2xl:px-[40px] py-[40px] md:py-[50px] group hover:bg-primary-color"
                    data-aos="fade-right"
                  ...
                  >
                    <div
                      className="w-[120px] h-[120px] leading-[120px] text-[64px] text-white text-center rounded-full mb-[25px]"
                      style={{
                        background:
                    ...
                    <h3 className="mb-[15px] text-[22px] md:text-[24px] group-hover:text-white">
                      {value.title}
                    </h3>
