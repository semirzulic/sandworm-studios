  ...
  return (
    <>
      <div className="container">
        <div 
          className="rounded-[20px] relative px-[30px] py-[50px] md:py-[70px] lg:py-[112px]"
          style={{
            background:
        ...
        >
          ...
          <Image
            src={shapeImg1}
            alt="shape"
            className="absolute bottom-0 left-0 rtl:right-0 lg:max-w-[150px] xl:max-w-[220px] 2xl:max-w-[250px] hidden lg:block"
          />
          <Image
            src={shapeImg2}
            alt="shape"
            className="absolute top-0 right-0 lg:max-w-[150px] xl:max-w-[220px] 2xl:max-w-[250px] hidden lg:block"
          />
        </div>
      </div>
    </>
